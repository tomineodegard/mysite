...
@post("/api-update-user-cover-picture")
...
def _():
    try:
        ...
        if cookie_user:
            ...
            user_cover_picture = cookie_user["user_cover_picture"]
        print("I am here --------------------")
        ...
        rows_affected = db.execute(f"""
            UPDATE users
            SET user_cover_picture = ?
            WHERE user_id = ?
        """, (user_cover_picture_image_name, user_id)).rowcount
        ...
        return {
            "info": "user_cover_picture uploaded",
            "user_cover_picture": user_cover_picture_image_name
            }
