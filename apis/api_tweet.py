...
def _():
  try: # SUCCESS
    ...
    tweet_total_views = ""
    tweet_total_replies = ""
    db.execute("INSERT INTO users VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"(tweet_id, tweet_message, tweet_image, tweet_created_at, tweet_user_fk, tweet_updated_at, tweet_total_retweets, tweet_total_likes, tweet_total_dislikes, tweet_total_views, tweet_total_replies))
    db.commit()
