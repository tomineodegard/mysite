         ...
         <div class="w-full pr-4 pt-4 pb-4">
          ...
          <div class="flex justify-between">
              <a href="#" class="flex justify-between gap-2 items-center text-base font-medium text-white">
                ...
                <svg width="20" height="20" viewBox="0 0 24 24" class="text-twitterBlue"><path fill="currentColor" d="m8.6 22.5l-1.9-3.2l-3.6-.8l.35-3.7L1 12l2.45-2.8l-.35-3.7l3.6-.8l1.9-3.2L12 2.95l3.4-1.45l1.9 3.2l3.6.8l-.35 3.7L23 12l-2.45 2.8l.35 3.7l-3.6.8l-1.9 3.2l-3.4-1.45Zm2.35-6.95L16.6 9.9l-1.4-1.45l-4.25 4.25l-2.15-2.1L7.4 12Z"/></svg>
                <p class="ml-1 text-sm text-twitterLightGray font-medium transition ease-in-out duration-150">
